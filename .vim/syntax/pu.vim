" Vim syntax file
" Language:	Puli
" Maintainer:	Ákos Kovács <akoskovacs@gmx.com>
" " Last Change:	2011  
...
syn keyword	cStatement	ugrás vissz tovább vég blokk fgv egyenlő nem kisebb nagyobb hamis igaz ki be hiba kezdet midig 
syn keyword	cLabel		választ alap eset sorozat unió ref újsor megáll folytat
...
if exists("c_curly_error")
  ...
  syntax region	cBlock		start="fgv" end="vég" contains=ALLBUT,cCurlyError,@cParenGroup,cErrInParen,cCppParen,cErrInBracket,cCppBracket,cCppString,@Spell fold
else
...
syn keyword	cOperator	méreted <-
if exists("c_gnu")
  syn keyword	cStatement	__asm__
  syn keyword	cOperator	typeof __real__ __imag__
endif
syn keyword	cType		egész hosszú karak semmi bool szöveg bool
syn keyword	cType		signed unsigned kistört tört
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		méret ssize_t off_t wchar_t ptrdiff_t sig_atomic_t fpos_t
...
syn keyword	cStructure	egyesített unió sorol typedef
syn keyword	cStorageClass	static regiszter auto volatile extern konst
if exists("c_gnu")
